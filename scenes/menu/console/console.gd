## Console Console. Provide a runtime GDScript REPL so your can run any script expressions in your game!
##
...
##
## @tutorial:            https://github.com/Ark2000/ConsoleConsole
...
@onready var _console_ui = $LynxWindows/ConsoleWindow/Body/Content/ConsoleConsoleUI
@onready var _base_instance = $BaseInstance
@onready var _windows = $LynxWindows

const _monitor_widget_pck = preload("res://scenes/menu/console/components/widgets2/monitor_widget.tscn")
...
func _ready():
	...
	toggle_console_action = "toggle_console_action"
	
	print(ConsoleConfig.get_config())
	...
	var w_data = ConsoleConfig.get_config()["widgets_data"]
	for w in w_data:
...
func _notification(what):
	...
	if what == 1006:
		...
		var cfg = ConsoleConfig.get_config()
		cfg["widgets_data"] = widgets_data
		ConsoleConfig.set_config(cfg)
