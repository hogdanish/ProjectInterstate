...
const icon_method = preload("res://scenes/menu/console/res/pics/icons8-formula-fx-32.png")
const icon_const = preload("res://scenes/menu/console/res/pics/icons8-pi-32.png")
const icon_prop = preload("res://scenes/menu/console/res/pics/icons8-object-32.png")
...
#	var s = load("res://scenes/menu/console/default_env.gd")
