...
#var did_kill: bool # did the character just kill someone?
...
#var special_type: String # what's the special move/action? Should be an enum and update a HUD icon etc
#
