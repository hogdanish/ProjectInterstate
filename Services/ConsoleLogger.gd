...
func bbcode_to_ansi(p_bbcode: String) -> String:
	...
	var res := (p_bbcode
			...
			# Dark text color
			.replace("[color=dark_red]", "\u001b[31m")
			.replace("[color=dark_green]", "\u001b[92m")
			.replace("[color=dark_lime]", "\u001b[32m")
			.replace("[color=dark_yellow]", "\u001b[33m")
			.replace("[color=dark_blue]", "\u001b[34m")
			.replace("[color=dark_magenta]", "\u001b[35m")
			.replace("[color=dark_cyan]", "\u001b[36m")
			.replace("[/color]", "\u001b[39m")
