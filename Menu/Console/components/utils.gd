...
const icon_method = preload("res://Menu/Console/res/pics/icons8-formula-fx-32.png")
const icon_const = preload("res://Menu/Console/res/pics/icons8-pi-32.png")
const icon_prop = preload("res://Menu/Console/res/pics/icons8-object-32.png")
